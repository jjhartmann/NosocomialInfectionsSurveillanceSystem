...
urlpatterns = [
    ...
    url(r'^public_resource/symptoms/$', views.symptoms, name='symptoms'),
    url(r'^public_resource/cause/$', views.cause, name='cause'),
    ...
    url(r'^public_resource/transmission/$', views.transmission_type, name='transmission_type'),
    url(r'^public_resource/prevention/$', views.prevention, name='prevention'),
    url(r'^FAQs/$', views.FAQs, name='FAQs'),
    url(r'^contact_us/$', views.contact_us, name='contact_us'),
    url(r'^public_resource/$', views.public_resource, name='public_resource'),
]
