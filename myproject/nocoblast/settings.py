"""
user defined nocoblast app settings file
"""
...
# path to nucleotide nocoblast database
...
EXAMPLE_FASTA_NUCL_FILE_PATH = os.path.join(BASE_DIR, 'sampledata/sample_nucl.fasta')
EXAMPLE_FASTA_PROT_FILE_PATH = os.path.join(BASE_DIR, 'sampledata/sample_prot.fasta')

# maximum number of query sequences in from
BLAST_MAX_NUMBER_SEQ_IN_INPUT = 10

# forms styling provided from css
BLAST_FORM_ATTRS = {'class': 'nocoblast_input_seq_form'}
BLAST_FORM_INPUTTEXT_ATTRS = {'class': 'nocoblast_input_textfield_form'}
